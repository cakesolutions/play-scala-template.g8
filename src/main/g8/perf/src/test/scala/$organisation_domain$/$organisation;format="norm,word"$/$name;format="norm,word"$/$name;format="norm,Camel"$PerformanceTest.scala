...
import $organisation_domain$.$organisation;format="norm,word"$.$name;format="norm,word"$.core.config.ConfigHelper._
import $organisation_domain$.$organisation;format="norm,word"$.$name;format="norm,word"$.core.config.ValidatedServerConfig

// scalastyle:off magic.number

object $name;format="norm,Camel"$PerformanceTest {
...
class $name;format="norm,Camel"$PerformanceTest extends Simulation {

  import $name;format="norm,Camel"$PerformanceTest._
