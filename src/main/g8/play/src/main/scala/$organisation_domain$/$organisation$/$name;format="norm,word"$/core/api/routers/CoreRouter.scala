package $organisation_domain$.$organisation$.$name;format="norm,word"$.core.api.routers
...
import $organisation_domain$.$organisation$.$name;format="norm,word"$.core.api.controllers._
